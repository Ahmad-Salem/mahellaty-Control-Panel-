...
<html lang="en">
    ...
    <body>
        ...
        <div class="body_content container" >
            ...
            <div class="add_user add_shop">
                <form action="add_advertisement_background.php" method="POST" id="add_advertisement_submit" enctype="multipart/form-data">
                    <h4 class="text-center">إضافة بيانات الأعلان الممول</h4>
                        <br/>
       ...
       <!-- pop up of logout model -->
            ...
            <div class="modal-content mod_con">
              ...
              <div class="modal-body mod_body">
                <h4 class="text-center h4"><img 
                    <?php if(@$_SESSION['Success_advertisement_check_paid']=="true"):?>
                    ...
                    >&nbsp;&nbsp;<?php echo @$_SESSION['message_advertisement_paid'];?></b> </h4>
              </div>
        ...
        <?php if(@$_SESSION['Success_advertisement_check_paid']):?>
        ...
        <?php endif;?>
        <?php @$_SESSION['Success_advertisement_check_paid']=null;?>
