    ...
    <body>
        ...
        <div class="header">
            <div class="container">
                ...
                <div class="settings">
                    ...
                    <a href="manage_advertisement/add_advertisement.php"><i class="fa fa-plus fa-lg"></i></a>
                    <a href="#" id="logout">...</a>
                </div>
            </div>
        </div>
                ...
                <div class="right_list">
                    ...
                    <div class="panel_links">
                        <ul class="list-unstyled ">
                            ...
                            <li class="active"><a href="manage_advertisement.php"><i class="fa fa-bell "></i> <span>إدارة الأعلانات الرئيسية</span></a></li>
                      ...
                      <table class="table table-bordered statistic_tbl" id="statistic_tbl_advertisement">
                          <tbody>
                              <tr class="active">
                                ...
                                <td>تاريخ بداية الاعلان</td>
                                <td>تاريخ نهاية الاعلان</td>
                                <td>مدة الاعلان</td>
                                <td>التفعيل</td>
                                <td>الصلاجيات</td>
                              </tr>
                              <?php
                              $query_display_advertisement="SELECT `id`, `advertisement_title`, `advertisement_description`, `advertisement_photo`, `government`, `city`, `activated`, `from_date`, `to_date`, `cost` FROM `advertisement`";
                              ...
                              while($advertisement_row=mysqli_fetch_assoc($perform_query_display_advertisement))
                              {
                                ...
                                echo "<td>".$advertisement_row['advertisement_title']."</td>";
                                echo "<td><img src=\"images/advertisement/".$advertisement_row['id']."/".$advertisement_row['advertisement_photo']."\" title=\"".$advertisement_row['advertisement_title']."\"/></td>";
                                echo "<td>".$advertisement_row['advertisement_description']."</td>";
                                echo "<td>".$advertisement_row['government'].",".$advertisement_row['city']."</td>";
                                ...
                                echo "<td>";
                                echo "<a href=\"manage_advertisement/edit_advertisement.php?ad_id=".$advertisement_row['id']."\">";
        ...
        <script type="text/javascript">
            ...
            function active_advertisement(row_id)
            {
                ...
                var row_id=row_id;
                var url = "manage_advertisement/active_paid_advertisement.php";
            ...
            function deactive_advertisement(row_id)
            {
                ...
                // Create some variables we need to send to our PHP file    
                var row_id=row_id;
                var url = "manage_advertisement/deactive_paid_advertisement.php";
                var vars = "ad_id="+row_id;
        ...
        <script type="text/javascript">
            ...
            function delete_advertisement(advetisement_no)
            {
                ...
                var url = "manage_advertisement/delete_advertisement.php";
