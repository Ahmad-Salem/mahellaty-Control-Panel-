$(document).ready(function(){
	...
	$("#add_advertisement_submit").submit(function(){
		...
		if(Error_advertisement_cost==false&&Error_advertisement_duration_from==false&&Error_advertisement_duration_to==false&&Error_city==false&&Error_advertisement_title==false&&Error_advertisement_description==false&&Error_government==false)
		{
			return true;
		}else
		{
