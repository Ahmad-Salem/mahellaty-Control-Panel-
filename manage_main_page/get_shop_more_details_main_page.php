<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query_shop_details="SELECT `id`, `shop_name`, `country`,`government`,`city`, `allowed_products` , `allowed_offers`,`main_page`, `address`,`shop_activity` FROM `shop` WHERE `shop_name` LIKE '%{$search}' OR `shop_name` LIKE '{$search}%' OR `shop_name` LIKE '%{$search}%' ";
