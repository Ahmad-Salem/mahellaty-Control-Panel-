    ...
    <body>
        ...
        <div class="body_content container">
            ...
            <div class="add_user add_shop">
                <form action="add_advertisement_background.php" method="POST" id="add_advertisement_submit" enctype="multipart/form-data">
                    <h4 class="text-center">إضافة بيانات الأعلان</h4>
                        <br/>
                        <input type="text" id="add_advertisement_duration_from"  placeholder="تاريخ بداية الاعلان "  name="add_advertisement_duration_from" class="from_date input form-control" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_duration_from">خطأ كبير يا نجم</p>
                        
                        <br/>
                        <br/>
                        <input type="text" id="add_advertisement_duration_to"  placeholder="تاريخ انتهاء الاعلان"  name="add_advertisement_duration_to" class="from_date input form-control" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_duration_to">خطأ كبير يا نجم</p>
                        
                        <br/>

                        <input type="text" id="add_advertisement_cost"   placeholder="أدخل  تكلفة الاعلان بالجنيه المصري"  name="add_advertisement_cost" class="input" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_cost">خطأ كبير يا نجم</p>
                        
                        <br/>
                        <input type="text" id="add_advertisement" placeholder="أدخل عنوان الأعلان"  name="add_advertisement_title" class="input" />
                        <br/><br/>
                        ...
                        <br/>
                        <textarea placeholder="أضف وصفا للاعلان..." class="textarea" id="advertisement_desc" name="advertisement_description"></textarea>
                        <p class="error" id="Error_advertisement_description">خطأ كبير يا نجم</p>
                        <br/><br/>
                        
                        <input type="submit" value="إضافة الأعلان"  name="login_sub" class="btn_edit_user" />
       ...
       <!-- pop up of logout model -->
        ...
        <script src="../javascript/add_advertisement.js"></script>
