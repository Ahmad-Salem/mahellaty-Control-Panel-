    ...
    <body>
        ...
        <div class="body_content container">
            <?php
                ...
                $query_get_advertisement_paid="SELECT `id`, `advertisement_title`, `advertisement_description`, `advertisement_photo`, `government`, `city`, `activated`, `from_date`, `to_date`, `cost` FROM `advertisement` WHERE `id`='{$advertisement_id}' LIMIT 1";
            ...
            <div class="add_user add_shop">
                <form action="edit_advertisement_background.php" method="POST" id="add_advertisement_submit" enctype="multipart/form-data">
                    <h4 class="text-center">تعديل بيانات الاعلان</h4>
                        <br/>
                        ...
                        <br/>
                        <br/>
                        <input type="text" id="add_advertisement_duration_to"  placeholder="تاريخ انتهاء الاعلان"  name="add_advertisement_duration_to" class="from_date input form-control" value="<?php echo date_format($myDateTime1, "Y-m-d"); ?>" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_duration_to">خطأ كبير يا نجم</p>
                        
                        <br/>

                        <input type="text" id="add_advertisement_cost"   placeholder="أدخل  تكلفة الاعلان بالجنيه المصري"  name="add_advertisement_cost" class="input" value="<?php echo $adver_paid_row['cost']?>" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_cost">خطأ كبير يا نجم</p>
                        
                        <br/>
                        <input type="text" id="add_advertisement" placeholder="أدخل عنوان الأعلان"  value="<?php echo $adver_paid_row['advertisement_title']?>" name="add_advertisement_title" class="input" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_title">خطأ كبير يا نجم</p>
                        
                        <div class="upload_photo_container">
                            
                            <img src="<?php echo "../images/advertisement/{$adver_paid_row['id']}/{$adver_paid_row['advertisement_photo']}"; ?>" class="image_preview"/>
                         ...
                         <!-- government type-->
                          <div class="kind">
                            <select id="add_government" name="government" >
                                ...
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة القاهرة"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة القاهرة">محافظة القاهرة</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الجِيزَة"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الجِيزَة">محافظة الجِيزَة</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة القليوبية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة القليوبية">محافظة القليوبية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الإسكندرية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الإسكندرية">محافظة الإسكندرية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة البحيرة"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة البحيرة">محافظة البحيرة</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة مطروح"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة مطروح">محافظة مطروح</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة دمياط"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة دمياط">محافظة دمياط</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الدقهلية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الدقهلية">محافظة الدقهلية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة كفر الشيخ"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة كفر الشيخ">محافظة كفر الشيخ</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الغربية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الغربية">محافظة الغربية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة المنوفية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة المنوفية">محافظة المنوفية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الشرقية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الشرقية">محافظة الشرقية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة بورسعيد"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة بورسعيد">محافظة بورسعيد</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الإسماعيلية"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الإسماعيلية">محافظة الإسماعيلية</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة السويس"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة السويس">محافظة السويس</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة شمال سيناء"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة شمال سيناء">محافظة شمال سيناء</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة جنوب سيناء"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة جنوب سيناء">محافظة جنوب سيناء</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة بني سويف"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة بني سويف">محافظة بني سويف</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الفيوم"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الفيوم">محافظة الفيوم</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة المنيا"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة المنيا">محافظة المنيا</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة أسيوط"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة أسيوط">محافظة أسيوط</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة البحر الأحمر"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة البحر الأحمر">محافظة البحر الأحمر</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة سوهاج"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة سوهاج">محافظة سوهاج</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة قنا"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة قنا">محافظة قنا</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة الأقصر"):?>
                                     selected
                                <?php endif;?>
                                value="محافظة الأقصر">محافظة الأقصر</option>
                                <option 
                                <?php if($adver_paid_row['government']=="محافظة أَسْوان"):?>
                                     selected
                                <?php endif;?>
                        ...
                        <br/>
                        <textarea placeholder="أضف وصفا للاعلان..." class="textarea" id="advertisement_desc" name="advertisement_description"><?php echo $adver_paid_row['advertisement_description'];?></textarea>
                        <p class="error" id="Error_advertisement_description">خطأ كبير يا نجم</p>
                        <br/><br/>
       ...
       <!-- pop up of logout model -->
        ...
        <script src="../javascript/edit_advertisement.js"></script>
