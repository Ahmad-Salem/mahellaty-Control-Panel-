	...
	if($_POST['do_action']=="get_offers_list")
	{
		...
		if(!empty($shop_id)&&!empty($limit)&&!empty($page))
		{
			...
			while($row_offers=mysqli_fetch_assoc($perform_query_offer_list))
			{
				...
				$photo="http://ma7latcom.com/59a1cac00edcbfa80c57957dc1e9018a/images/users/".$user_id."/".$row_offers['photo'];
