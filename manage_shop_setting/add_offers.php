    ...
    <body>
        ...
        <div class="body_content container">
            ...
            <div class="add_user add_shop">
                <form action="add_offer_background.php" method="POST" id="add_offer_submit" enctype="multipart/form-data">
                    <h4 class="text-center">إضافة بيانات العرض</h4>
                        <br/>
                        <input type="text" id="add_advertisement_duration_from"  placeholder="تاريخ بداية العرض "  name="add_advertisement_duration_from" class="from_date input form-control" />
                        <br/><br/>
                        <p class="error" id="Error_advertisement_duration_from">خطأ كبير يا نجم</p>
                        
                        <br/>
                        <br/>
                        <input type="text" id="add_advertisement_duration_to"  placeholder="تاريخ انتهاء العرض"  name="add_advertisement_duration_to" class="from_date input form-control" />
                        <br/><br/>
                        ...
                        <!-- country type-->
                          <div class="kind">
                              <select id="add_offer_kind" name="offer_kind" >
                                  ...
                                  <option value="1">عرض علي الصفحة الرئيسيه</option>
                        ...
                        <input type="text" id="add_offer" placeholder="أدخل اسم العرض"  name="add_offer_name" class="input" />
                        <br/><br/>
                        ...
                        <div class="file-input wrapper photo_btn">
                                ...
                                <input id="add_offer_photo" type="file" name="add_offer_photo"  class="file-input control" />
                         ...
                         <p class="error" id="Error_offer_photo">خطأ كبير يا نجم</p>
                         <br/>
                         
                        <br/>
                        <textarea placeholder="أضف وصفا للعرض..." class="textarea" id="offer_desc" name="offer_description"></textarea>
                        <p class="error" id="Error_offer_description">خطأ كبير يا نجم</p>
                        <br/><br/>
                        <input type="hidden" value="<?php echo $_GET['sid'];?>" name="shop_no"/>
                        <input type="submit" value="إضافة العرض"  name="login_sub" class="btn_edit_user" />
