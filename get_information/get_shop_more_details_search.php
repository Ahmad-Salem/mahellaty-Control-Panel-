<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query_shop_details="SELECT `id`, `shop_name`, `user_id`, `country`, `government` , `city` ,`address`, `user_id`, `shop_activity`, `allowed_products`, `allowed_offers`,`approve` FROM `shop` WHERE `shop_name` LIKE '%{$search}' OR `shop_name` LIKE '{$search}%' OR `shop_name` LIKE '%{$search}%' ";
